...
class TestFeatureFlagLambdaHandler:
    ...
    def test_handler_missing_user_id(self):
        ...
        event = {"queryStringParameters": {"flag_key": "new_checkout"}}
    ...
    def test_handler_empty_user_id(self):
        ...
        event = {"queryStringParameters": {"user_id": "", "flag_key": "new_checkout"}}
    ...
    def test_handler_with_user_context(self, mock_evaluator_class):
        ...
        event = {
            ...
            "body": json.dumps(
                {"context": {"country": "US", "platform": "web", "age": 25}}
            ),
        }
    ...
    def test_handler_internal_server_error(self, mock_evaluator_class):
        ...
        mock_evaluator = Mock()
        mock_evaluator.get_flag_config_cached.side_effect = Exception(
    ...
    def test_handler_response_headers_cors(self):
        ...
        event = {"queryStringParameters": {"flag_key": "test"}}
    ...
    def test_handler_response_headers_content_type(self):
        ...
        event = {"queryStringParameters": {"user_id": "user_123", "flag_key": "test"}}
    ...
    def test_handler_no_request_body(self, mock_evaluator_class):
        ...
        # No body in event
        event = {
            "queryStringParameters": {"user_id": "user_123", "flag_key": "new_checkout"}
        }
    ...
    def test_handler_whitespace_user_id(self, mock_evaluator_class):
        ...
        event = {
            "queryStringParameters": {"user_id": "   ", "flag_key": "new_checkout"}
        }
    ...
    def test_handler_records_evaluation_event_to_kinesis(
        self, mock_evaluator_class, mock_record_event
    ):
    ...
    def test_handler_tracking_event_includes_all_metadata(
        ...
        event_with_context = {
            **self.valid_event,
            "body": json.dumps({"context": {"country": "US", "user_tier": "premium"}}),
        }
