...
class TestErrorMiddleware:
    ...
    async def test_successful_request(
        self, middleware, mock_request, mock_response, mock_aws_client
    ):
    ...
    async def test_error_tracking_disabled(self, app, mock_aws_client, mock_request):
        ...
        middleware = ErrorMiddleware(
            app, aws_client=mock_aws_client, track_errors=False
        )
        error_message = "Test error"
    ...
    async def test_custom_metric_namespace(self, app, mock_aws_client, mock_request):
        ...
        middleware = ErrorMiddleware(
            app, aws_client=mock_aws_client, metric_namespace="CustomNamespace"
        )
        error_message = "Test error"
        ...
        assert (
            mock_aws_client.send_metric.call_args[1]["namespace"] == "CustomNamespace"
        )
