"""
Unit tests for EP-050: PHI Encryption (backend/app/core/phi_encryption.py).
...
Run with:
    ...
    python -m pytest backend/tests/unit/core/test_phi_encryption.py -v
"""
...
class TestInitialisation:
    ...
    def test_none_key_without_settings_raises_runtime_error(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "backend.app.core.phi_encryption.Fernet",
