...
class TestArrayLengthEquals:
    ...
    def test_length_equals_exact(self):
        ...
        result = apply_operator(
            OperatorType.ARRAY_LENGTH, [1, 2, 3], 3, additional_value="eq"
        )
        assert result is True

    def test_length_equals_zero(self):
        """Test that empty array has length zero."""
        result = apply_operator(OperatorType.ARRAY_LENGTH, [], 0, additional_value="eq")
        assert result is True

    def test_length_not_equals(self):
        """Test that array length does not equal wrong number."""
        result = apply_operator(
            OperatorType.ARRAY_LENGTH, [1, 2, 3], 5, additional_value="eq"
        )
    ...
    def test_length_equals_string_array(self):
        ...
        result = apply_operator(
            OperatorType.ARRAY_LENGTH, ["a", "b", "c", "d"], 4, additional_value="eq"
        )
        assert result is True
...
class TestArrayLengthGreaterThan:
    ...
    def test_length_greater_than(self):
        ...
        result = apply_operator(
            OperatorType.ARRAY_LENGTH, [1, 2, 3, 4], 3, additional_value="gt"
        )
        assert result is True
    ...
    def test_length_not_greater_when_equal(self):
        ...
        result = apply_operator(
            OperatorType.ARRAY_LENGTH, [1, 2, 3], 3, additional_value="gt"
        )
        assert result is False
    ...
    def test_length_not_greater_when_less(self):
        ...
        result = apply_operator(
            OperatorType.ARRAY_LENGTH, [1, 2], 3, additional_value="gt"
        )
        assert result is False
    ...
    def test_length_greater_than_zero(self):
        ...
        result = apply_operator(
            OperatorType.ARRAY_LENGTH, [1], 0, additional_value="gt"
        )
        assert result is True
...
class TestArrayLengthLessThan:
    ...
    def test_length_less_than(self):
        ...
        result = apply_operator(
            OperatorType.ARRAY_LENGTH, [1, 2], 3, additional_value="lt"
        )
        assert result is True
    ...
    def test_length_not_less_when_equal(self):
        ...
        result = apply_operator(
            OperatorType.ARRAY_LENGTH, [1, 2, 3], 3, additional_value="lt"
        )
        assert result is False
    ...
    def test_length_not_less_when_greater(self):
        ...
        result = apply_operator(
            OperatorType.ARRAY_LENGTH, [1, 2, 3, 4], 3, additional_value="lt"
        )
        assert result is False

    def test_empty_array_less_than_one(self):
        """Test that empty array has length less than one."""
        result = apply_operator(OperatorType.ARRAY_LENGTH, [], 1, additional_value="lt")
        assert result is True
...
class TestArrayLengthGreaterThanOrEqual:
    ...
    def test_length_gte_when_greater(self):
        ...
        result = apply_operator(
            OperatorType.ARRAY_LENGTH, [1, 2, 3, 4], 3, additional_value="gte"
        )
        assert result is True
    ...
    def test_length_gte_when_equal(self):
        ...
        result = apply_operator(
            OperatorType.ARRAY_LENGTH, [1, 2, 3], 3, additional_value="gte"
        )
        assert result is True
    ...
    def test_length_gte_when_less(self):
        ...
        result = apply_operator(
            OperatorType.ARRAY_LENGTH, [1, 2], 3, additional_value="gte"
        )
        assert result is False
...
class TestArrayLengthLessThanOrEqual:
    ...
    def test_length_lte_when_less(self):
        ...
        result = apply_operator(
            OperatorType.ARRAY_LENGTH, [1, 2], 3, additional_value="lte"
        )
        assert result is True
    ...
    def test_length_lte_when_equal(self):
        ...
        result = apply_operator(
            OperatorType.ARRAY_LENGTH, [1, 2, 3], 3, additional_value="lte"
        )
        assert result is True
    ...
    def test_length_lte_when_greater(self):
        ...
        result = apply_operator(
            OperatorType.ARRAY_LENGTH, [1, 2, 3, 4], 3, additional_value="lte"
        )
        assert result is False
...
class TestArrayLengthInvalidInputs:
    ...
    def test_non_array_value_none(self):
        ...
        result = apply_operator(
            OperatorType.ARRAY_LENGTH, None, 3, additional_value="eq"
        )
        assert result is False
    ...
    def test_non_array_value_string(self):
        ...
        result = apply_operator(
            OperatorType.ARRAY_LENGTH, "hello", 5, additional_value="eq"
        )
    ...
    def test_non_array_value_number(self):
        ...
        result = apply_operator(OperatorType.ARRAY_LENGTH, 42, 1, additional_value="eq")
    ...
    def test_tuple_as_array(self):
        ...
        result = apply_operator(
            OperatorType.ARRAY_LENGTH, (1, 2, 3, 4), 4, additional_value="eq"
        )
        assert result is True
    ...
    def test_invalid_comparison_type(self):
        ...
        result = apply_operator(
            OperatorType.ARRAY_LENGTH, [1, 2, 3], 3, additional_value="invalid"
        )
        assert result is False
    ...
    def test_negative_expected_length(self):
        ...
        result = apply_operator(
            OperatorType.ARRAY_LENGTH, [1, 2, 3], -1, additional_value="eq"
        )
    ...
    def test_expected_value_not_number(self):
        ...
        result = apply_operator(
            OperatorType.ARRAY_LENGTH, [1, 2, 3], "three", additional_value="eq"
        )
        assert result is False
...
class TestArrayLengthEdgeCases:
    ...
    def test_very_large_array(self):
        ...
        result = apply_operator(
            OperatorType.ARRAY_LENGTH, large_array, 10000, additional_value="eq"
        )
        assert result is True
    ...
    def test_array_with_none_elements(self):
        ...
        result = apply_operator(
            OperatorType.ARRAY_LENGTH, [1, None, 3, None, 5], 5, additional_value="eq"
        )
        assert result is True

    def test_default_comparison_without_additional_value(self):
        """Test that without additional_value, defaults to equality."""
        result = apply_operator(OperatorType.ARRAY_LENGTH, [1, 2, 3], 3)
