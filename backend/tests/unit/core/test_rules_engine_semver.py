...
class TestSemanticVersionEquals:
    ...
    def test_not_equal_different_prerelease(self):
        ...
        result = apply_operator(
            OperatorType.SEMANTIC_VERSION, "1.0.0-alpha", "1.0.0-beta"
        )
        assert result is False
    ...
    def test_equal_with_build_metadata(self):
        ...
        result = apply_operator(
            OperatorType.SEMANTIC_VERSION, "1.0.0+build.123", "1.0.0+build.456"
        )
        assert result is True
...
class TestSemanticVersionGreaterThan:
    ...
    def test_minor_version_greater(self):
        ...
        result = apply_operator(
            OperatorType.SEMANTIC_VERSION, "1.10.0", "1.9.0", additional_value="gt"
        )
        assert result is True
    ...
    def test_patch_version_greater(self):
        ...
        result = apply_operator(
            OperatorType.SEMANTIC_VERSION, "1.2.4", "1.2.3", additional_value="gt"
        )
        assert result is True
    ...
    def test_not_greater_when_less(self):
        ...
        result = apply_operator(
            OperatorType.SEMANTIC_VERSION, "1.2.3", "2.0.0", additional_value="gt"
        )
        assert result is False
    ...
    def test_not_greater_when_equal(self):
        ...
        result = apply_operator(
            OperatorType.SEMANTIC_VERSION, "1.2.3", "1.2.3", additional_value="gt"
        )
        assert result is False
    ...
    def test_prerelease_less_than_release(self):
        ...
        result = apply_operator(
            OperatorType.SEMANTIC_VERSION, "1.0.0", "1.0.0-alpha", additional_value="gt"
        )
        assert result is True
...
class TestSemanticVersionLessThan:
    ...
    def test_major_version_less(self):
        ...
        result = apply_operator(
            OperatorType.SEMANTIC_VERSION, "1.2.3", "2.0.0", additional_value="lt"
        )
        assert result is True
    ...
    def test_minor_version_less(self):
        ...
        result = apply_operator(
            OperatorType.SEMANTIC_VERSION, "1.2.0", "1.3.0", additional_value="lt"
        )
        assert result is True
    ...
    def test_patch_version_less(self):
        ...
        result = apply_operator(
            OperatorType.SEMANTIC_VERSION, "1.2.3", "1.2.4", additional_value="lt"
        )
        assert result is True
    ...
    def test_not_less_when_greater(self):
        ...
        result = apply_operator(
            OperatorType.SEMANTIC_VERSION, "2.0.0", "1.2.3", additional_value="lt"
        )
        assert result is False
    ...
    def test_not_less_when_equal(self):
        ...
        result = apply_operator(
            OperatorType.SEMANTIC_VERSION, "1.2.3", "1.2.3", additional_value="lt"
        )
        assert result is False
    ...
    def test_prerelease_less_than_release(self):
        """Test that pre-release version is less than release version."""
        result = apply_operator(
            OperatorType.SEMANTIC_VERSION, "1.0.0-rc.1", "1.0.0", additional_value="lt"
        )
        assert result is True
...
class TestSemanticVersionInvalidFormat:
    ...
    def test_invalid_format_two_parts(self):
        ...
        result = apply_operator(OperatorType.SEMANTIC_VERSION, "1.2", "1.2.3")
    ...
    def test_invalid_format_with_v_prefix(self):
        ...
        result = apply_operator(OperatorType.SEMANTIC_VERSION, "v1.2.3", "1.2.3")
    ...
    def test_invalid_format_non_numeric(self):
        ...
        result = apply_operator(OperatorType.SEMANTIC_VERSION, "1.x.3", "1.2.3")
        assert result is False

    def test_invalid_format_none_value(self):
        """Test handling of None value."""
        result = apply_operator(OperatorType.SEMANTIC_VERSION, None, "1.2.3")
        assert result is False

    def test_invalid_format_empty_string(self):
        """Test handling of empty string."""
        result = apply_operator(OperatorType.SEMANTIC_VERSION, "", "1.2.3")
        assert result is False
...
class TestSemanticVersionGreaterThanOrEqual:
    ...
    def test_greater_than_or_equal_when_greater(self):
        ...
        result = apply_operator(
            OperatorType.SEMANTIC_VERSION, "2.0.0", "1.0.0", additional_value="gte"
        )
        assert result is True
    ...
    def test_greater_than_or_equal_when_equal(self):
        ...
        result = apply_operator(
            OperatorType.SEMANTIC_VERSION, "1.2.3", "1.2.3", additional_value="gte"
        )
        assert result is True
    ...
    def test_greater_than_or_equal_when_less(self):
        ...
        result = apply_operator(
            OperatorType.SEMANTIC_VERSION, "1.0.0", "2.0.0", additional_value="gte"
        )
        assert result is False
...
class TestSemanticVersionLessThanOrEqual:
    ...
    def test_less_than_or_equal_when_less(self):
        ...
        result = apply_operator(
            OperatorType.SEMANTIC_VERSION, "1.0.0", "2.0.0", additional_value="lte"
        )
        assert result is True
    ...
    def test_less_than_or_equal_when_equal(self):
        ...
        result = apply_operator(
            OperatorType.SEMANTIC_VERSION, "1.2.3", "1.2.3", additional_value="lte"
        )
        assert result is True
    ...
    def test_less_than_or_equal_when_greater(self):
        ...
        result = apply_operator(
            OperatorType.SEMANTIC_VERSION, "2.0.0", "1.0.0", additional_value="lte"
        )
        assert result is False
