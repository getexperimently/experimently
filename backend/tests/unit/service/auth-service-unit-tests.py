...
# Or with pytest (which can also run unittest-style tests)
...
class TestCognitoAuthService(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Create service instance with mocked boto3 client
    ...
    def test_initialization_without_env_vars(self):
        ...
        # Service should warn about missing vars but not fail
        with self.assertLogs(level='WARNING') as cm:
            auth_service = CognitoAuthService()
            self.assertIn("COGNITO_USER_POOL_ID or COGNITO_CLIENT_ID not set", cm.output[0])
    ...
    def test_sign_up_success(self):
        ...
        self.mock_client.sign_up.assert_called_with(
            ...
            UserAttributes=[
                ...
                {'Name': 'family_name', 'Value': 'Test User'},
            ]
        )
    ...
    def test_sign_in_success(self):
        ...
        # Call the service method
        result = self.auth_service.sign_in(
            username="testuser",
            password="Password123!"
        )
