"""
SSO Service — EP-037 SSO/SAML & OIDC Enterprise Authentication.
...
All SAML operations gracefully degrade to stub implementations when the
...
def parse_saml_response(config: SSOConfig, saml_response_b64: str) -> Dict[str, Any]:
    ...
    # Stub implementation used when python3-saml is not installed.
