...
| `codedeploy:ContinueDeployment` | `.github/workflows/rollback.yml: aws deploy continue-deployment` |
...
| `codedeploy:GetDeployment` | `.github/workflows/rollback.yml: aws deploy get-deployment` |
...
| `codedeploy:ListDeployments` | `.github/workflows/rollback.yml: aws deploy list-deployments` |
