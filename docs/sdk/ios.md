...
`Experimently` is a Swift Package (iOS 14+, macOS 11+, Swift 5.5+) providing feature flag
...
Xcode: File → Add Package Dependencies… → Add Local… → `sdk/ios` → product `Experimently`.
