...
class TestRoleHierarchy:
    ...
    def test_role_hierarchy_order(self):
        from modules.backend.app.models.workspace import ROLE_HIERARCHY
    ...
    def test_five_distinct_roles(self):
        from modules.backend.app.models.workspace import WorkspaceMemberRole
...
class TestWorkspaceServiceExceptions:
    ...
    def test_all_exception_classes_exist(self):
        from modules.backend.app.services import workspace_service as ws
