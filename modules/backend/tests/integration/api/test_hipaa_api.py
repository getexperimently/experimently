...
Patterns follow modules/backend/tests/integration/api/test_split_url_api.py:
...
class TestCreateBaa:
    ...
    _SVC_CREATE = "modules.backend.app.api.v1.endpoints.hipaa.HIPAAService.create_baa"
    _SVC_DEACTIVATE = (
        "modules.backend.app.api.v1.endpoints.hipaa.HIPAAService.deactivate_baa"
    )
    ...
    def test_admin_can_create_baa(self, admin_client):
        ...
        with patch(self._SVC_CREATE, return_value=mock_baa):
            with patch(
                "modules.backend.app.schemas.hipaa.BAAConfigResponse.model_validate",
...
class TestListBaas:
    ...
    _SVC_LIST = (
        "modules.backend.app.api.v1.endpoints.hipaa.HIPAAService.get_baa_configs"
    )
...
class TestGetBaa:
    ...
    _SVC_GET = "modules.backend.app.api.v1.endpoints.hipaa.HIPAAService.get_baa_by_id"
...
class TestListAuditLogs:
    ...
    _SVC_GET_LOGS = (
        "modules.backend.app.api.v1.endpoints.hipaa.HIPAAService.get_phi_audit_logs"
    )
...
class TestCreateAuditLog:
    ...
    _SVC_LOG = "modules.backend.app.api.v1.endpoints.hipaa.HIPAAService.log_phi_access"
...
class TestHipaaReport:
    ...
    _SVC_REPORT = (
        "modules.backend.app.api.v1.endpoints.hipaa.HIPAAService.generate_hipaa_report"
    )
...
class TestEncryptDecrypt:
    ...
    _SVC_ENCRYPT = (
        "modules.backend.app.api.v1.endpoints.hipaa.HIPAAService.encrypt_phi_field"
    )
    _SVC_DECRYPT = (
        "modules.backend.app.api.v1.endpoints.hipaa.HIPAAService.decrypt_phi_field"
    )
    _SVC_LOG = "modules.backend.app.api.v1.endpoints.hipaa.HIPAAService.log_phi_access"
...
class TestHipaaStatus:
    ...
    _SVC_STATUS = (
        "modules.backend.app.api.v1.endpoints.hipaa.HIPAAService.get_hipaa_status"
    )
