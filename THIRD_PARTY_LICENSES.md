...
Generated by `scripts/generate_third_party_licenses.py` on 2026-09-13.
...
| Package | Version |
|---|---|
| `@getexperimently/react-sdk` | 1.1.0 |
| `js-tokens` | 4.0.0 |
| `loose-envify` | 1.4.0 |
| `react` | 18.3.1 |
| `react-dom` | 18.3.1 |
...
| `@babel/types` | 7.29.8 |
| `@getexperimently/react-native-sdk` | 0.1.0 |
...
|---|---|
| `@getexperimently/js-sdk` | 1.0.0 |
| `@getexperimently/openfeature-provider` | 0.2.0 |
...
| Package | Version |
|---|---|
| `@getexperimently/edge-sdk` | 0.2.0 |
