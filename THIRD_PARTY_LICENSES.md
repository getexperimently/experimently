...
Generated by `scripts/generate_third_party_licenses.py` on 2026-09-12.
...
## Python — backend, Lambda functions, infrastructure

The transitive closure of the pins in `backend/requirements.txt` (runtime, test and CDK pins together) and `modules/requirements.txt` (the module-only pins the full profile installs), with versions and licences read from the installed distributions by `pip-licenses`. Packages that happen to be installed but are not reachable from a pin are not dependencies and are not listed.
...
| `aws-cdk.cloud-assembly-schema` | 54.23.0 |
| `aws-xray-sdk` | 2.15.0 |
| `bcrypt` | 4.3.0 |
| `boto3` | 1.43.89 |
| `botocore` | 1.43.92 |
...
| `constructs` | 10.5.1 |
| `coverage` | 7.13.4 |
| `databricks-sql-connector` | 3.7.5 |
| `freezegun` | 1.5.5 |
| `ghp-import` | 2.1.0 |
...
| Package | Version |
|---|---|
| `@experimentation-platform/js-sdk` | 1.0.0 |
...
| Package | Version |
|---|---|
| `@experimentation-platform/react-sdk` | 1.1.0 |
| `js-tokens` | 4.0.0 |
| `loose-envify` | 1.4.0 |
| `react` | 18.3.1 |
| `react-dom` | 18.3.1 |
...
| `@babel/types` | 7.29.8 |
| `@experimentation-platform/react-native-sdk` | 0.1.0 |
...
|---|---|
| `@experimentation-platform/js-sdk` | 1.0.0 |
| `@experimentation-platform/openfeature-provider` | 0.2.0 |
...
| Package | Version |
|---|---|
| `@experimentation-platform/edge-sdk` | 0.2.0 |
