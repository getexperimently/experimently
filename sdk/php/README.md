...
`./vendor/bin/phpunit` runs the PHPUnit 10 suite, with HTTP faked by `tests/FakeHttpClient.php`:
...
`php test_standalone.php` needs no Composer: it checks the hash vector, the types, the cache and
