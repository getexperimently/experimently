defmodule ExperimentationPlatform.Config do
  @moduledoc """
  Configuration struct for the ExperimentationPlatform SDK client.

  ## Required fields
  - `:base_url` - The base URL of the Experimentation Platform API (e.g., "https://api.example.com")
  ...
  - `:http_client` - HTTP client module to use (default: ExperimentationPlatform.HttpClient). Useful for testing.
  """
