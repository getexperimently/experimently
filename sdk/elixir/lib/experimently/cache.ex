defmodule Experimently.Cache do
  @moduledoc """
  ...
  - `{:flag, user_id, flag_key}` -> `%Experimently.FlagEvaluation{}`
  - `{:assignment, user_id, experiment_key}` -> `%Experimently.Assignment{}`
