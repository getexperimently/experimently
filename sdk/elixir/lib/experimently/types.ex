defmodule Experimently.FlagEvaluation do
  @moduledoc """
...
defmodule Experimently.Assignment do
  @moduledoc """
...
defmodule Experimently.BatchResult do
  @moduledoc """
  Aggregated result of `Experimently.track_batch/2`
