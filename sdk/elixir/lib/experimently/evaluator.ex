defmodule Experimently.Evaluator do
  @moduledoc """
  ...
  decided by the server (see `Experimently.Client`).
  """
  ...
  ## Examples
      ...
      iex> Experimently.Evaluator.hash_user("user-123", "my-flag")
      0.6927449859213084

      iex> result = Experimently.Evaluator.hash_user("user-abc", "feature-xyz")
