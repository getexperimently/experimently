...
RSpec.describe ExperimentationPlatform::Client do
  ...
  describe '#initialize' do
    it 'accepts a SdkConfig object' do
      config = ExperimentationPlatform::SdkConfig.new(base_url: base_url, api_key: api_key)
  ...
  describe '#get_assignment' do
    ...
    it 'maps the response to an Assignment' do
      ...
      expect(assignment).to be_a(ExperimentationPlatform::Assignment)
  ...
  describe '#evaluate_flag' do
    ...
    it 'maps the response to a FlagEvaluation' do
      ...
      expect(result).to be_a(ExperimentationPlatform::FlagEvaluation)
  ...
  describe '#track_batch' do
    it 'POSTs {events: [...]} and maps the response to a BatchResult' do
      ...
      expect(result).to be_a(ExperimentationPlatform::BatchResult)
