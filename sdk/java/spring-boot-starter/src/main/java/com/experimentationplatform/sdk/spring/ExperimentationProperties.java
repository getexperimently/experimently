...
/**
 * Configuration properties for the Experimentation Platform SDK, bound from the
 ...
 * <pre>
 * experimentation.api-key=my-secret-api-key
 * experimentation.base-url=https://api.experimentation-platform.example.com
...
public class ExperimentationProperties {
    ...
    /**
     * API key used to authenticate SDK requests to the Experimentation Platform.
     * Required — auto-configuration is disabled when this is absent.
     */
    private String apiKey;

    /**
     * Base URL of the Experimentation Platform API (no trailing slash).
     * Default: {@code https://api.experimentation-platform.example.com}
     */
    private String baseUrl = "https://api.experimentation-platform.example.com";
