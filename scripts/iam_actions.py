...
#: Once a workflow names it, its entry must go (a test fails until it does):
#: `ecs_rolling_rollout.sh` was staged here until deploy.yml and rollback.yml
#: ran it (#69).
STAGED_SCRIPTS: list[Path] = []
