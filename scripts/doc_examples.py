...
PENDING_FROZEN: dict[str, tuple[int, int, int]] = {
    ...
    "docs/api/integrations.md": (3, 8, 0),
    ...
    "docs/deployment/AWS_ROUTE53_DEPLOYMENT.md": (29, 2, 0),
    "docs/deployment/README.md": (13, 0, 0),
    "docs/deployment/deployment-guide.md": (7, 1, 3),
    ...
    "docs/getting-started/architecture.md": (0, 4, 0),
    "docs/getting-started/concepts.md": (0, 4, 0),
    ...
    "docs/guides/user-guide.md": (0, 8, 0),
    ...
    "docs/integrations/aws.md": (10, 0, 0),
    ...
    "docs/monitoring/log-insights-queries.md": (0, 13, 0),
    "docs/monitoring/monitoring-guide.md": (4, 1, 0),
    ...
    "docs/sdk-guide.md": (2, 0, 0),
    "docs/sdk/android.md": (1, 0, 0),
    "docs/sdk/dotnet.md": (3, 0, 0),
    "docs/sdk/edge.md": (3, 0, 0),
    "docs/sdk/elixir.md": (4, 0, 0),
    "docs/sdk/flutter.md": (2, 0, 0),
    "docs/sdk/go.md": (3, 0, 0),
    "docs/sdk/ios.md": (2, 0, 0),
    "docs/sdk/java.md": (2, 0, 0),
    "docs/sdk/javascript.md": (4, 1, 0),
    "docs/sdk/openfeature.md": (8, 2, 0),
    "docs/sdk/php.md": (3, 0, 0),
    "docs/sdk/python.md": (5, 0, 0),
    "docs/sdk/react-native.md": (4, 1, 0),
    "docs/sdk/react.md": (3, 0, 0),
    "docs/sdk/ruby.md": (3, 0, 0),
    "docs/security-architecture.md": (0, 1, 0),
    "docs/security/api-keys.md": (4, 1, 0),
    "docs/security/incident-response-plan.md": (40, 3, 6),
    "docs/security/security-policies.md": (0, 1, 0),
    "docs/security/threat-model.md": (0, 3, 0),
    "docs/self-hosting/cdk.md": (12, 1, 2),
    ...
    "docs/statistics/power-analysis.md": (0, 3, 0),
    "docs/testing/autonomous-testing-framework.md": (33, 5, 1),
    ...
    "sdk/php/README.md": (3, 0, 0),
    "sdk/python/README.md": (4, 0, 0),
    "sdk/react/README.md": (4, 0, 0),
